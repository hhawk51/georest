...
bool c_MgServerFeatureUtil::m_isInitialized = c_MgServerFeatureUtil::Initialize();

INT32 c_MgServerFeatureUtil::GetMgPropertyType(FdoDataType fdoDataType)
{
    return s_FeatureUtilFdoDataType[fdoDataType];
}

bool c_MgServerFeatureUtil::FindCustomFunction(CREFSTRING funcName, INT32 &index)
{
...
FdoOrderingOption c_MgServerFeatureUtil::GetFdoOrderingOption(INT32 orderingOption)
{
...
bool c_MgServerFeatureUtil::Initialize()
{
...
STRING c_MgServerFeatureUtil::GetMessage(CREFSTRING messageId)
{
    STRING msg = MgUtil::GetResourceMessage(MgResources::FeatureService, messageId);
    return msg;
}

INT16 c_MgServerFeatureUtil::GetMgPropertyType(MgPropertyDefinition* propDef)
{
    CHECKNULL((MgPropertyDefinition*)propDef, L"c_MgServerFeatureUtil.GetMgPropertyType")
...
MgPropertyDefinitionCollection* c_MgServerFeatureUtil::GetPropertyDefinitions(MgReader* reader)
{
    CHECKNULL(reader, L"c_MgServerFeatureUtil.GetPropertyDefinitions");
...
void c_MgServerFeatureUtil::GetArguments(FdoFunction* customFunction, REFSTRING name, int &numCats, double& dataMin, double& dataMax, INT16 type)
{
    ...
    if (cnt < 2)
    {
        STRING message = c_MgServerFeatureUtil::GetMessage(L"MgInvalidComputedProperty");

        MgStringCollection arguments;
        arguments.Add(customFunction->GetName());
        throw new MgFeatureServiceException(L"c_MgServerFeatureUtil.GetArguments", __LINE__, __WFILE__, &arguments, L"", NULL);
    }
    ...
    CHECKNULL((FdoExpression*)expr0, L"c_MgServerFeatureUtil.GetArguments");
    arg0 = expr0->ToString(); // Name of function

    FdoPtr<FdoExpression> expr1 = exprCol->GetItem(argCnt+1);
    CHECKNULL((FdoExpression*)expr1, L"c_MgServerFeatureUtil.GetArguments");
    arg1 = expr1->ToString(); // No of categories

    if (cnt > 2)
    {
        FdoPtr<FdoExpression> expr2 = exprCol->GetItem(argCnt+2);
        CHECKNULL((FdoExpression*)expr2, L"c_MgServerFeatureUtil.GetArguments");
        arg2 = expr2->ToString(); // Min Range

        if (cnt > 3)
        {
            FdoPtr<FdoExpression> expr3 = exprCol->GetItem(argCnt+3);
            CHECKNULL((FdoExpression*)expr3, L"c_MgServerFeatureUtil.GetArguments");
...
INT32 c_MgServerFeatureUtil::GetPropertyDefinition(MgReader* reader, REFSTRING propName)
{
    CHECKNULL((MgReader*)reader, L"c_MgServerFeatureUtil.GetPropertyDefinition");

    INT32 cnt = reader->GetPropertyCount();
    if (cnt != 1)
    {
        STRING message = c_MgServerFeatureUtil::GetMessage(L"MgOnlyOnePropertyAllowed");

        MgStringCollection arguments;
        arguments.Add(message);
        throw new MgFeatureServiceException(L"c_MgServerFeatureUtil.GetPropertyDefinition", __LINE__, __WFILE__, &arguments, L"", NULL);
    }
...
bool c_MgServerFeatureUtil::FindCustomFunction(FdoFunction* customFunction, INT32 &index)
{
...
void c_MgServerFeatureUtil::ValidateCustomConstraints(FdoFunction* customFunction)
{
        ...
        switch(funcCode)
        {
            ...
            case JENK_CATEGORY: // Jenk Category
            {
                if (cnt < 2)
                {
                    ...
                    MgStringCollection arguments;
                    arguments.Add(message);
                    throw new MgFeatureServiceException(L"c_MgServerFeatureUtil.ValidateCustomConstraints",
...
double c_MgServerFeatureUtil::Minimum(VECTOR& v)
{
    int cnt = (int)v.size();
    if (cnt <= 0)
        throw new MgIndexOutOfRangeException(L"c_MgServerFeatureUtil.Minimum", __LINE__, __WFILE__, NULL, L"", NULL);
    double min = v[0];
    for (int i = 1; i < cnt; ++i)
    {
        double val = v[i];
...
INT64 c_MgServerFeatureUtil::Minimum(VECTOR_INT64& v)
{
    int cnt = (int)v.size();
    if (cnt <= 0)
        throw new MgIndexOutOfRangeException(L"c_MgServerFeatureUtil.Minimum", __LINE__, __WFILE__, NULL, L"", NULL);
...
double c_MgServerFeatureUtil::Maximum(VECTOR& v)
{
    int cnt = (int)v.size();
    if (cnt <= 0)
        throw new MgIndexOutOfRangeException(L"c_MgServerFeatureUtil.Maximum", __LINE__, __WFILE__, NULL, L"", NULL);
    double max = v[0];
    for (int i = 1; i < cnt; ++i)
    {
        double val = v[i];
...
INT64 c_MgServerFeatureUtil::Maximum(VECTOR_INT64& v)
{
    int cnt = (int)v.size();
    if (cnt <= 0)
        throw new MgIndexOutOfRangeException(L"c_MgServerFeatureUtil.Maximum", __LINE__, __WFILE__, NULL, L"", NULL);
...
FdoSpatialOperations c_MgServerFeatureUtil::GetFdoSpatialOperation(INT32 spatialOp)
{
...
INT32 c_MgServerFeatureUtil::GetMgFeaturePropertyType(FdoPropertyType fdoPropType)
{
...
void c_MgServerFeatureUtil::FillFdoPropertyCollection(MgPropertyCollection* srcCol, FdoPropertyValueCollection* paramCol)
{
    CHECKNULL(srcCol, L"c_MgServerFeatureUtil.FillFdoPropertyCollection")
    CHECKNULL(paramCol, L"c_MgServerFeatureUtil.FillFdoPropertyCollection")
...
FdoParameterValueCollection* c_MgServerFeatureUtil::CreateFdoParameterCollection(MgPropertyCollection* srcCol)
{
    CHECKNULL(srcCol, L"c_MgServerFeatureUtil.FillFdoPropertyCollection")
...
FdoLiteralValue* c_MgServerFeatureUtil::MgPropertyToFdoDataValue(MgProperty* srcProp)
{
    CHECKNULL(srcProp, L"c_MgServerFeatureUtil.MgPropertyToFdoProperty")
    ...
    switch(propType)
    {
        ...
        {
            throw new MgInvalidPropertyTypeException(L"c_MgServerFeatureUtil.MgPropertyToFdoProperty",
...
FdoParameterValue* c_MgServerFeatureUtil::MgPropertyToFdoParameter(MgProperty* srcProp)
{
...
FdoPropertyValue* c_MgServerFeatureUtil::MgPropertyToFdoProperty(MgProperty* srcProp)
{
    FdoPtr<FdoLiteralValue> fdoValue = MgPropertyToFdoDataValue(srcProp);
    STRING str = srcProp->GetName();
...
INT32 c_MgServerFeatureUtil::FdoOrderTypeToMgOrderingOption(FdoOrderType type)
{
...
FdoOrderType c_MgServerFeatureUtil::MgOrderingOptionToFdoOrderType(INT32 type)
{
...
INT32 c_MgServerFeatureUtil::FdoObjectTypeToMgObjectPropertyType(FdoObjectType type)
{
...
FdoObjectType c_MgServerFeatureUtil::MgObjectPropertyTypeToFdoObjectType(INT32 type)
{
...
MgStringCollection* c_MgServerFeatureUtil::FdoToMgStringCollection(FdoStringCollection* fdoStrs, bool includeEmptyStrings)
{
...
FdoStringCollection* c_MgServerFeatureUtil::MgToFdoStringCollection(MgStringCollection* mgStrs, bool includeEmptyStrings)
{
...
MgClassDefinition* c_MgServerFeatureUtil::GetMgClassDefinition(FdoClassDefinition* fdoClassDefinition, bool bSerialize)
{
    CHECKNULL(fdoClassDefinition, L"c_MgServerFeatureUtil.GetMgClassDefinition");

    // Create MgClassDefinition
    Ptr<MgClassDefinition> mgClassDef = new MgClassDefinition();
    CHECKNULL((MgClassDefinition*)mgClassDef, L"c_MgServerFeatureUtil.GetMgClassDefinition");
    ...
    CHECKNULL((MgPropertyDefinitionCollection*)propDefCol, L"c_MgServerFeatureUtil.GetMgClassDefinition");
    ...
    CHECKNULL((MgPropertyDefinitionCollection*)identityPropDefCol, L"c_MgServerFeatureUtil.GetMgClassDefinition");
    ...
    CHECKNULL((FdoPropertyDefinitionCollection*)fpdc, L"c_MgServerFeatureUtil.GetMgClassDefinition");
    ...
    // Add properties
    c_MgServerFeatureUtil::GetClassProperties(propDefCol, fpdc);
    ...
    c_MgServerFeatureUtil::GetClassProperties(identityPropDefCol, fdpdc);
...
MgByteReader* c_MgServerFeatureUtil::SerializeToXml(FdoClassDefinition* classDef)
{
    CHECKNULL(classDef, L"c_MgServerFeatureUtil.SerializeToXml");
    ...
    CHECKNULL(bytes, L"c_MgServerFeatureUtil::SerializeToXml");
...
void c_MgServerFeatureUtil::GetClassProperties(MgPropertyDefinitionCollection* propDefCol,
                                             FdoPropertyDefinitionCollection* fdoPropDefCol)
{
    ...
    for (FdoInt32 i =0; i < cnt; i++)
    {
        ...
        CHECKNULL((FdoPropertyDefinition*)fpd, L"c_MgServerFeatureUtil.GetClassProperties");

        // Create MgProperty
        Ptr<MgPropertyDefinition> prop = c_MgServerFeatureUtil::GetMgPropertyDefinition(fpd);
...
MgPropertyDefinition* c_MgServerFeatureUtil::GetMgPropertyDefinition(FdoPropertyDefinition* fdoPropDef)
{
    CHECKNULL((FdoPropertyDefinition*)fdoPropDef, L"c_MgServerFeatureUtil.GetMgPropertyDefinition");
    ...
    switch (fpt)
    {
        ...
        {
            propDef = c_MgServerFeatureUtil::GetDataPropertyDefinition((FdoDataPropertyDefinition*)fdoPropDef);
            break;
        }
        // Represents an Object Property type.
        case FdoPropertyType_ObjectProperty:
        {
            propDef = c_MgServerFeatureUtil::GetObjectPropertyDefinition((FdoObjectPropertyDefinition*)fdoPropDef);
            break;
        }
        ...
        {
            propDef = c_MgServerFeatureUtil::GetGeometricPropertyDefinition((FdoGeometricPropertyDefinition*)fdoPropDef);
            break;
        }
        ...
        {
            propDef = c_MgServerFeatureUtil::GetRasterPropertyDefinition((FdoRasterPropertyDefinition*)fdoPropDef);
            break;
        }
    }
...
MgDataPropertyDefinition* c_MgServerFeatureUtil::GetDataPropertyDefinition(FdoDataPropertyDefinition* fdoPropDef)
{
    if (fdoPropDef == NULL)
    {
        return NULL;
...
MgObjectPropertyDefinition* c_MgServerFeatureUtil::GetObjectPropertyDefinition(FdoObjectPropertyDefinition* fdoPropDef)
{
    CHECKNULL((FdoObjectPropertyDefinition*)fdoPropDef, L"c_MgServerFeatureUtil.GetObjectPropertyDefinition");
    ...
    CHECKNULL((FdoClassDefinition*)fdoClsDef, L"c_MgServerFeatureUtil.GetObjectPropertyDefinition")
    ...
    Ptr<MgClassDefinition> objPropClsDef = c_MgServerFeatureUtil::GetMgClassDefinition(fdoClsDef, true);
    Ptr<MgDataPropertyDefinition> objIdenProp = c_MgServerFeatureUtil::GetDataPropertyDefinition(idenProp);
    INT32 orderOption = c_MgServerFeatureUtil::FdoOrderTypeToMgOrderingOption(orderType);
    INT32 mgObjType = c_MgServerFeatureUtil::FdoObjectTypeToMgObjectPropertyType(objType);
...
MgGeometricPropertyDefinition* c_MgServerFeatureUtil::GetGeometricPropertyDefinition(FdoGeometricPropertyDefinition* fdoPropDef)
{
    CHECKNULL((FdoGeometricPropertyDefinition*)fdoPropDef, L"c_MgServerFeatureUtil.GetGeometricPropertyDefinition");
...
MgRasterPropertyDefinition* c_MgServerFeatureUtil::GetRasterPropertyDefinition(FdoRasterPropertyDefinition* fdoPropDef)
{
    CHECKNULL((FdoRasterPropertyDefinition*)fdoPropDef, L"c_MgServerFeatureUtil.GetRasterPropertyDefinition");
...
MgProperty* c_MgServerFeatureUtil::GetMgProperty(MgReader* reader, CREFSTRING qualifiedPropName, INT16 type)
{
    // Null Reader is invalid
    CHECKNULL(reader, L"c_MgServerFeatureUtil.GetMgProperty");
