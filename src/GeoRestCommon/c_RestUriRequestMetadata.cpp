...
/// </summary>
c_RestUriRequestMetadata::c_RestUriRequestMetadata()
{
    // Nothing here yet
}
...
/// </returns>
bool c_RestUriRequestMetadata::AddProperty(CREFSTRING property, CREFSTRING value)
{
...
/// </returns>
bool c_RestUriRequestMetadata::RemoveProperty(CREFSTRING property)
{
...
/// </returns>
STRING c_RestUriRequestMetadata::GetPropertyValue(CREFSTRING property)
{
    if (m_reqMetadataCollection.Contains(property))
    {
...
/// </returns>
bool c_RestUriRequestMetadata::SetPropertyValue(CREFSTRING name, CREFSTRING value)
{
...
/// </returns>
MgStringCollection* c_RestUriRequestMetadata::GetPropertyNames()
{
...
void c_RestUriRequestMetadata::Dispose()
{
    delete this;
}

INT32 c_RestUriRequestMetadata::GetClassId()
{
    return m_cls_id;
}
