...
#ifndef _c_RestUriRequestMetadata_h
#define _c_RestUriRequestMetadata_h

class c_RestUriRequestMetadata;
template class REST_COMMON_API Ptr<c_RestUriRequestMetadata>;
...
/// </summary>
class REST_COMMON_API c_RestUriRequestMetadata : public MgDisposable
{
    EXTERNAL_API:
        c_RestUriRequestMetadata();
    ...
    INTERNAL_API:
        ...
        /// </summary>
        virtual ~c_RestUriRequestMetadata();
...
CLASS_ID:
        static const INT32 m_cls_id = 0; // HttpHandler_MapAgent_HttpRequestMetadata;
};
