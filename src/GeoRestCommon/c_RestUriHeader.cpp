...
/// </summary>
c_RestUriHeader::c_RestUriHeader()
{
    // Nothing here yet
}
...
/// </returns>
bool c_RestUriHeader::AddHeader(CREFSTRING name, CREFSTRING value)
{
...
/// </returns>
bool c_RestUriHeader::RemoveHeader(CREFSTRING name)
{
...
/// </returns>
STRING c_RestUriHeader::GetHeaderValue(CREFSTRING name)
{
    if (m_headerCollection.Contains(name))
    {
...
/// </returns>
bool c_RestUriHeader::SetHeaderValue(CREFSTRING name, CREFSTRING value)
{
    if (m_headerCollection.Contains(name))
    {
...
/// </returns>
long c_RestUriHeader::GetDateHeader(CREFSTRING name)
{
...
/// </returns>
INT32 c_RestUriHeader::GetIntHeader(CREFSTRING name)
{
    if (m_headerCollection.Contains(name))
    {
        ...
        for (unsigned int i=0; i < strlen(headerIntCString); i++)
            if (!isdigit(headerIntCString[i]))
                return D_CANNOT_CONVERT;

        return atoi(headerIntCString);
    }
    else
        return D_MISSING_HEADER;
}
...
/// </returns>
MgStringCollection* c_RestUriHeader::GetHeaderNames()
{
...
/// </returns>
MgStringCollection* c_RestUriHeader::GetHeaders(CREFSTRING name)
{
    MG_UNUSED_ARG(name);
...
void c_RestUriHeader::Dispose()
{
    delete this;
}

INT32 c_RestUriHeader::GetClassId()
{
    return 0;
}
