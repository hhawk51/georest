...
//
#ifndef _c_OData_Interface_h
#define _c_OData_Interface_h
...
class REST_REQUEST_HANDLER_API c_OData_Interface
{

public:
  static c_OData_Interface* Impl(); 

public:
  enum e_OdataFormatType
  {
    e_OdataAtom,
    e_OdataJson
  };
...
public:
  ...
  virtual e_OdataFormatType GetResponseFormatType(c_RestRequest* RestRequest) = 0;
  virtual void CreateServiceDocument( c_RestConfig* CfgRest,std::ostream& OutStream,const std::string& BaseURI,e_OdataFormatType& Format ) = 0;
  virtual void CreateServiceMetadata( c_RestConfig* CfgRest,std::ostream& OutStream,const std::string& BaseURI ) = 0;
  virtual void Reader2AtomCollection( c_RestRequest* RestRequest,const c_CfgRepOdata* ODataRepresentation,c_RestDataReader* Reader,std::ostream & OutStream,e_OdataFormatType& Format ) = 0;
  virtual void Reader2AtomEntry( c_RestRequest* RestRequest,const c_CfgRepOdata* ODataRepresentation,c_RestDataReader* Reader
    ,std::ostream & OutStream,e_OdataFormatType& Format,std::wstring& OneProperty,bool IsRawValue ) = 0;
  ...
  virtual void ParseKeyValueString(const std::wstring& KeysVal,MgClassDefinition* DataClassDef,MgPropertyCollection* Props,std::wstring& SingleValue)=0;    
