...
#ifndef _MGRESTTASK_H
#define _MGRESTTASK_H
...
//
//
class MgRestTask : public MgRestRequestResponseHandler
{
public:
...
public:
    ...
    /// nothing
    /// </returns>
    MgRestTask(MgRestRequest *Request);
    ...
    void Execute_Post_StartWebLayout(MgHttpResponse& HttpResponse);
    void AddStyleRanges(c_TreeNode_MgLayerGroup& Node,MgResourceService* resourceService,const std::string& BaseUri);
