...
/// </returns>
bool c_RestHeader::AddHeader(CREFSTRING name, CREFSTRING value)
{
...
/// </returns>
bool c_RestHeader::RemoveHeader(CREFSTRING name)
{
...
/// </returns>
STRING c_RestHeader::GetHeaderValue(CREFSTRING name)
{
    if (m_headerCollection.Contains(name))
    {
...
/// </returns>
bool c_RestHeader::SetHeaderValue(CREFSTRING name, CREFSTRING value)
{
    if (m_headerCollection.Contains(name))
    {
...
/// </returns>
long c_RestHeader::GetDateHeader(CREFSTRING name)
{
...
/// </returns>
INT32 c_RestHeader::GetIntHeader(CREFSTRING name)
{
    if (m_headerCollection.Contains(name))
    {
...
/// </returns>
MgStringCollection* c_RestHeader::GetHeaderNames()
{
...
/// </returns>
MgStringCollection* c_RestHeader::GetHeaders(CREFSTRING name)
{
    MG_UNUSED_ARG(name);
...
void c_RestHeader::Dispose()
{
    delete this;
}

INT32 c_RestHeader::GetClassId()
{
    return 0;
}
