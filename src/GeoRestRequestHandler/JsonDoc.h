...
public:
	...
	void Add(const char *name, const wstring & value);
    void Add(const string &name, const wstring & value);
	...
	void PrintStyled(string &result);
    void PrintFast(string &result);
    /// Data Members
private:
